...
public class ErrorMessage {
    ...
    public static final String WRONG_NAME_FORMAT = "각 이름은 한글 또는 영어 한자리 이상이어야 합니다";
    public static final String INCREASE_NAME_LENGTH = "각 이름은 "+MIN_NAME_LENGTH+"글자 이상이어야 합니다.";
    public static final String REDUCE_NAME_LENGTH = "각 이름은 "+MAX_NAME_LENGTH+"글자 이하이어야 합니다.";
    public static final String REDUCE_HATE_FOOD = "못먹는 메뉴는 "+MAX_HATE_FOOD_COUNT+"가지 이하여야 합니다.";
    public static final String HAVE_DUPLICATE_FOOD = "중복된 이름이 있습니다.";
}
