...
public enum Food {
    ...
    CHINESE(3, "중식", List.of("깐풍기", "볶음면", "동파육", "짜장면", "짬뽕", "마파두부", "탕수육", "달걀볶음", "고추잡채")),
    ASIAN(4, "일식", List.of("팟타이", "카오 팟", "나시고렝", "파인애플 볶음밥", "쌀국수", "똠얌꿍", "반미", "월남쌈", "분짜")),
    ...
    Food(int categoryIndex, String categoryName, List<String> foods) {
