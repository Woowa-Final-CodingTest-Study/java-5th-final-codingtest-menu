...
import menu.provider.CoachNameProvider;
import menu.provider.MenuProvider;
...
public class ApplicationTest extends NsTest {
    ...
    class AllFeatureTest {
        ...
        @ParameterizedTest
        @ArgumentsSource(MenuProvider.class)
        void 메뉴_입력_예외_테스트(String errorMessage, String... args) {
            assertTimeoutPreemptively(RANDOM_TEST_TIMEOUT, () -> {
                runException(args);
                assertThat(output()).contains(errorMessage);
            });
